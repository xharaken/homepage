...
foreach my $idlFile (@idlFiles) {
    ...
    print "full path of $idlFile is $fullPath\n";
...
foreach my $idlFile (sort keys %supplementals) {
    print "printing $idlFile\n";
    print "The supplemental list is @{$supplementals{$idlFile}}\n";
